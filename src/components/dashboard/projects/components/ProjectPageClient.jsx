...
import DashboardHeader from "./ProjectHeader";
...
const ProjectPageClient = () => {
  ...
  if (loading && !projects.length) return <LoadingState name="dashboard" />;

  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Welcome Banner */}
      <WelcomeBanner onCreateProject={handleAdd} />

      {/* Dashboard Stats */}
      <DashboardStats projects={projects} />

      {/* Header with Actions */}
      <DashboardHeader onAddProject={handleAdd} projectCount={projects.length} />
      ...
      {projects.length ? (
        ...
        <EmptyState onAddProject={handleAdd} />
      )}

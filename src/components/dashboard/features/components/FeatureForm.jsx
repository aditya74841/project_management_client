...
const FeatureForm = ({
  ...
  onSubmit,
  onCancel,
  onTagsChange, // Add tags change handler prop
}) => {
    ...
    <div className="bg-white p-8 rounded-xl shadow max-w-md mx-auto space-y-8">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <FormField
          ...
          onChange={onChange}
          onBlur={onBlur}
          helpText="Default is today's date"
        />
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={onTagsChange} // Use the special tags handler
            onBlur={onBlur}
          ...
          <div className="text-gray-500 text-sm">
            e.g., frontend, auth, api (max 10 tags, 20 chars each)
          </div>
        </div>

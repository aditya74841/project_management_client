...
export function AuthSheetFrame({
  ...
  const tones = {
    signin: {
      shell:
        "bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.18),_transparent_32%)] bg-slate-50 dark:bg-slate-950",
      side:
    ...
    signup: {
      shell:
        "bg-[radial-gradient(circle_at_top_left,_rgba(251,191,36,0.16),_transparent_30%)] bg-amber-50/10 dark:bg-slate-950",
      side:
  ...
  return (
    ...
    >
      <div className="relative hidden overflow-hidden lg:flex">
        ...
        <div className="absolute -left-14 top-14 h-44 w-44 rounded-full border border-white/10 bg-white/10 blur-3xl opacity-20" />
        <div className="absolute right-[-4.5rem] bottom-10 h-52 w-52 rounded-full border border-white/10 bg-white/10 blur-3xl opacity-20" />
      ...
      <div className="relative z-10 flex h-full flex-col px-5 py-6 sm:px-7 lg:px-8">
        <div className="mb-6 flex items-start justify-between">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200/80 dark:border-slate-800 bg-white/85 dark:bg-slate-900/50 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.26em] text-slate-500 dark:text-slate-400 shadow-sm backdrop-blur">
              <BadgeIcon className="h-4 w-4 text-slate-700 dark:text-slate-300" />
              {eyebrow}
            </div>

            <div className="space-y-2">
              <h2 className="max-w-md text-3xl font-semibold tracking-tight text-slate-900 dark:text-white sm:text-[2rem]">
                {title}
              </h2>
              <p className="max-w-md text-sm leading-6 text-slate-600 dark:text-slate-400 sm:text-[15px]">
                {description}
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 rounded-[28px] border border-white/70 dark:border-slate-800 bg-white/86 dark:bg-slate-900/80 p-4 shadow-[0_18px_60px_rgba(15,23,42,0.09)] dark:shadow-none backdrop-blur-xl sm:p-5">
          {children}
        </div>
